...
const handler = async (m, {conn, text, participants, isOwner, isAdmin}) => {
  try {
    ...
    const htextos = `${text ? text : '*Hola Soy Lancelotbot 😸*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029Vb5mi8y3wtb4XeFy8i2i'}}}}}, {});
    }
  }
};
