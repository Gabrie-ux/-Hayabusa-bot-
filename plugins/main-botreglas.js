...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    let crow = `🍫 *Respeta las reglas de LancelotBot*\n
✰ No llamar Al Bot
✰ No hacer spam
...
✨ 𝗔𝘃𝗶𝘀𝗼: *Puedes apoyarnos dejando una estrellita 🌟 al repositorio oficial de LancelotBot: ${repobot}*
