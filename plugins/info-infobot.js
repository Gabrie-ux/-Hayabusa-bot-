...
crisjm += `│ 🖇️ *${groupsIn.length}* Grupos Unidos\n`
crisjm += `│ 🥞 *${groupsIn.length - groupsIn.length}* Grupos Salidos\n`
crisjm += `│ 💬 *${chats.length - groupsIn.length}* Chats Privados\n`
criskm += `│ 💭 *${chats.length}* Chats Totasles\n`
crisjm += `╰─╼\n\n`
